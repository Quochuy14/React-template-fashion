              ...
              <div class="col-xl-7 col-lg-8">
                <nav class="header__menu">
                  <ul>
                    ...
                    <li><a href="#">TT Nam</a></li>
                    <li><a href="#">TT Nữ</a></li>
              ...
              <div class="col-lg-6 p-0">
                <div class="categories__item categories__large__item set-bg" data-setbg="assets/img/categories/category-1.jpg">
                  <div class="categories__text">
                    <h1>Thời trang Nữ</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean vel orci massa. Donec sollicitudin sapien ac velit dictum tincidunt. 
                    </p>
            ...
            <div class="row property__gallery">
              <div class="col-lg-3 col-md-4 col-sm-6 mix">
                <div class="product__item">
                  <div class="product__item__pic set-bg" data-setbg="assets/img/product/product-1.jpg">
                    <div class="label new">Mới nhất</div>
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Blazer buutons tweed</a></h5>
                    <div class="rating">
                    ...
                    <div class="product__price">590.000 vnđ</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mix">
                <div class="product__item">
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Flowy striped skirt</a></h5>
                    <div class="rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                    ...
                    <div class="product__price">490.000 vnđ</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mix">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 mix">
                <div class="product__item">
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Slim striped pocket shirt</a></h5>
                    <div class="rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 mix">
                <div class="product__item">
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Fit micro corduroy shirt</a></h5>
                    <div class="rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Tropical Kimono</a></h5>
                    <div class="rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                    ...
                    <div class="product__price">490.000 vnđ <span>590.000 vnđ</span></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Contrasting sunglasses</a></h5>
                    <div class="rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                  ...
                  <div class="product__item__text">
                    <h5><a href="#">Water resistant backpack</a></h5>
                    <div class="rating">
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
                      <i class="fa fa-star"></i>
              ...
              <div class="col-xl-7 col-lg-8 m-auto">
                <div class="banner__slider owl-carousel">
                  ...
                  <div class="banner__item">
                    <div class="banner__text">
                      <span>Bộ sưu tập</span>
                      <h1>Mùa đông 2022 không lạnh</h1>
                      <a href="#">Xem chi tiết</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="trend__content">
                  ...
                  <div class="trend__item">
                    ...
                    <div class="trend__item__text">
                      ...
                      <div class="product__price">390.000 vnđ <span>590.000 vnđ</span></div>
                    </div>
                  </div>
                  <div class="trend__item">
                    <div class="trend__item__pic">
                    ...
                    <div class="trend__item__text">
                      <h6>Zip-pockets pebbled tot5 <br />briefcase</h6>
                      <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="footer__copyright__text">
                  <p>
                    Copyright 2022 All rights Quochuy <i class="fa fa-heart" aria-hidden="true"></i>
                  </p>
                </div>
              </div>
            </div>
